  ...
  const getSocialIcon = (platform) => {
    ...
    switch (platform.toLowerCase()) {
      ...
      case "snapchat":
        return (
          <svg {...baseProps}>
            <path d="M12.065 0C5.91 0 .3 4.61.3 10.765c0 3.705 1.915 7.01 4.88 8.94-.08-.45-.12-.915-.12-1.395 0-4.64 3.775-8.415 8.415-8.415s8.415 3.775 8.415 8.415c0 .48-.04.945-.12 1.395 2.965-1.93 4.88-5.235 4.88-8.94C23.83 4.61 18.22 0 12.065 0z" />
          </svg>
        );
      case "pinterest":
        return (
      ...
      case "reddit":
        return (
          <svg {...baseProps}>
            <path d="M24 11.779c0-1.459-1.192-2.645-2.657-2.645-.715 0-1.363.286-1.84.746-1.81-1.191-4.259-1.949-6.971-2.046l1.483-4.669 4.016.941-.006.058c0 1.193.975 2.163 2.174 2.163 1.198 0 2.172-.97 2.172-2.163s-.975-2.163-2.172-2.163c-.92 0-1.704.574-2.012 1.357l-4.53-1.006c-.302 0-.592.14-.796.392l-1.79 5.522c-2.745.107-5.228.866-7.06 2.076-.48-.465-1.137-.746-1.857-.746C1.192 9.134 0 10.32 0 11.779c0 .713.288 1.36.784 1.84-.07.495-.106 1.005-.106 1.534 0 5.365 5.846 9.718 13.05 9.718s13.05-4.353 13.05-9.718c0-.529-.036-1.039-.106-1.534.496-.48.784-1.127.784-1.84zM6.961 14.345c-.316 0-.574-.258-.574-.575 0-.316.258-.575.574-.575.316 0 .574.259.574.575 0 .317-.258.575-.574.575zm7.078 0c-.316 0-.574-.258-.574-.575 0-.316.258-.575.574-.575.316 0 .574.259.574.575 0 .317-.258.575-.574.575z" />
          </svg>
        );
      case "discord":
        return (
      ...
      case "telegram":
        return (
          <svg {...baseProps}>
            <path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-1.447-1.238-1.447-1.238-.514-.435-.052-.67.371-.44.72.52 1.603 1.075 1.603 1.075.406 0 .414-.645.207-1.583-.168-.765-.612-1.806-1.238-3.766-.514-1.6-.809-3.14-1.105-4.878a.059.059 0 0 1 .02-.053.07.07 0 0 1 .006-.004l.01-.004h.004c1.316 0 2.38.615 3.642 1.527 2.593 1.79 4.437 3.432 6.457 5.037.898.788 1.512.832 1.768.832.36 0 .595-.083.705-.124.105-.04.14-.075.14-.075z" />
          </svg>
        );
      default:

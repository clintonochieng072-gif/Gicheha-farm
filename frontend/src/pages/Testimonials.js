...
const Testimonials = () => {
  ...
  const testimonialsStructuredData = {
    ...
    "@type": "WebPage",
    name: "Customer Testimonials - Gicheha Farm Rongai",
    description:
      "Read what our satisfied customers say about our fresh, organic farm products and exceptional service.",
    url: "https://gicheha-farm.onrender.com/public/testimonials",
    mainEntity: {
      "@type": "Organization",
  ...
  return (
    <>
      <SEO
        ...
        description={`Read ${testimonials.length} customer testimonials and reviews about Gicheha Farm Rongai's fresh, organic products. Average rating: ${averageRating} stars.`}
        keywords="customer testimonials, farm reviews, organic products feedback, customer satisfaction, Rongai Kenya farm reviews, fresh produce testimonials"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-secondary-600 max-w-2xl mx-auto">
            Hear what our satisfied customers have to say about our fresh,
            organic products.
          </p>
          {testimonials.length > 0 && (
          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-secondary-600">
                ...
                products. Your feedback helps us improve and helps other

  ...
  return (
    <>
      ...
      <div>
        {/* Hero Section */}
        <section
          className="relative bg-gradient-to-r from-primary-50 to-primary-100 py-20 overflow-hidden"
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1
                id="hero-heading"
                className="text-4xl md:text-6xl font-bold text-secondary-800 mb-6"
              >
                Fresh From Our Farm
                    ...
                    <>
                      <div>
                        ...
                        <p className="text-secondary-600 leading-relaxed">
                          ...
                          into a trusted source of fresh, organic produce for
                      ...
                      <div>
                        ...
                        <p className="text-secondary-600 leading-relaxed">
                          ...
                          both our customers and the environment. We are
                          committed to delivering freshness, nutrition, and
                          exceptional service in every product we offer.
                        </p>
                      </div>
                      <div>
                        <h3 className="text-xl font-semibold text-primary-600 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-secondary-600 leading-relaxed">
                      {abouts
                        .filter(
                          (about) =>
                            about.section === "history" && about.isActive
                        )
          ...
          <section className="py-16 bg-secondary-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-secondary-600 max-w-2xl mx-auto">
                  Get to know the dedicated professionals behind Gicheha Farm
                  who work tirelessly to bring you the freshest produce.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {team

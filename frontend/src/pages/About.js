            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-secondary-600">
                  <p>
                    Founded in 2005, Gicheha Farm Rongai started as a small
                    family farm with a simple mission: to grow the freshest,
                    most nutritious produce possible. What began as a modest
                    operation has grown into a thriving agricultural enterprise
                    that serves communities across Kenya.
                  </p>
                  <p>
                    We believe that healthy food starts with healthy soil.
                    That's why we use only organic farming methods, avoiding
                    synthetic pesticides and fertilizers. Our commitment to
                    sustainability extends beyond our fields – we actively work
                    to preserve biodiversity and support local ecosystems.
                  </p>
                  <p>
                    Today, we proudly supply fresh vegetables, fruits, dairy
                    products, and more to families who value quality and
                    freshness. Every product we grow tells a story of
                    dedication, care, and respect for nature.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-secondary-600 max-w-2xl mx-auto">
                These core values guide everything we do, from how we farm to
